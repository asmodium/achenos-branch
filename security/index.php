<?php require_once '../vars.php'; require_once '../config/config.php'; require_once '../lib/handling.php'; ?>
<?php 
  $user = new Handling();
?>
<!DOCTYPE html>
...
<div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
      <li class="nav-item">
        <a href="?pc=nome" class="nav-link text-dark font-italic bg-light">
  ...
  <div class="container"><?php
            if(isset($_GET['pc'])){
                ...
                switch($confp){
                    case "nome":
                        include_once DIR.'/security/editprofile/editname.php';
                        break;
                    case "senha":
                        include_once DIR.'/security/editprofile/editpassword.php';
                        break;
                    case "email":
                        include_once DIR.'/security/editprofile/editemail.php';
                        break;
                    case "pic":
                        include_once DIR.'/security/editprofile/editpic.php';
                        break;
                    default:
                        include_once DIR.'/security/index.php';
                        break;
                }
            }
            else{
